...
func _physics_process(delta: float):
	...
	gravity(delta)
	velocity = move_and_slide(velocity, Vector2.UP) #Aplica o movimento no personagem, move_and_slide é uma funçao do kinematicbody2D
	#move_and_slide() nao permite que o personaem atravesse colisoes
